...
exedir=/Users/liziwei/learning/CRTest/job
#for i in 5 
...
do
        ...
        rootname=model1_theta${i}phi${j}
        echo "the file is processing : $rootname"
        root -b -q "$exedir/Output.C(\"$rootname\")" >$outdir/run.log 2>&1
